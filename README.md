...
<body style="font-family: Georgia, Helvetica, Arial, Verdana, san-serif, Times;
			color: #000;
		...
		<div>
			<div style="margin-top:25px">
				<div style="height: 200px;">
					<div width="670px" style="float: left;">
						<div>
					...
					<div style="float: right;">
						<img style="width: 170px;" src="doc/Handsome guy photos.jpg" border="0" width="160"><br>
					</div>
				</div>
				<div>
					<h2>Biography</h2>
